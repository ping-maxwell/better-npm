	...
	return (
		<div className="space-y-6">
			...
			<div className="grid gap-3 grid-cols-2 sm:grid-cols-4">
				...
				/>
				<MiniStat label="Versions used" value={String(data.versions.length)} />
				{data.tracked && (
					<MiniStat
				...
				{data.tracked?.latest_known && (
					<MiniStat label="Latest reviewed" value={data.tracked.latest_known} />
				)}
				{!data.tracked && (
					<>
						<MiniStat
							...
							value={
								data.first_installed ? formatDate(data.first_installed) : "-"
							}
						/>
						<MiniStat
							label="Last installed"
							value={
								data.last_installed ? formatRelative(data.last_installed) : "-"
							}
						/>
					</>
				)}
